...
function TransferForm(){
    ...
    return(
        <div>
            <h1>Transfer Form</h1>
            <form>
            <TextField type="number" id="outlined-basic" label="Account Number" variant="outlined"  value={accountNumber} onChange={(e) => setAccountNumber(e.target.value)}/><br/>
            ...
            <TextField type="number" id="outlined-basic" label="Amount" variant="outlined" value={amount} onChange={(e) => setAmount(e.target.value)}/><br/>
